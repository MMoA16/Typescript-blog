...
//       try {
//         const res = await fetch(`${process.env.NEXT_PUBLIC_STRAPI_URL}/api/enquiry/send`, {
//           method: "POST",
...
//           setPopupMessage("Enquiry sent successfully!");
//           setName("");
//           setEmail("");
//           setEnquiryType("");
//           setDescription("");
...
//         console.error(error);
//         setPopupType("error");
//         setPopupMessage("Error sending enquiry");
//       }
//     };
...
//        {popupMessage && (
//         <div
//           className={`fixed top-6 right-6 px-4 py-2 rounded-lg shadow-md text-sm font-medium z-50 transition-opacity ${
//             popupType === "success"
...
//               errors.name ? "border-red-500 focus:ring-red-500" : "border-gray-400 focus:ring-gray-900"
//             }`}
//           />
...
//               errors.enquiryType ? "border-red-500 focus:ring-red-500" : "border-gray-400 focus:ring-gray-900"
//             }`}
//           >
...
//           </select>
//           {errors.enquiryType && (
//             <p className="text-red-600 text-xs mt-1 text-left">{errors.enquiryType}</p>
//           )}
//         </div>
...
//           />
//           {errors.description && (
//             <p className="text-red-600 text-xs mt-1 text-left">{errors.description}</p>
//           )}
//         </div>
